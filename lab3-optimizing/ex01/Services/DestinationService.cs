...
public class DestinationService : IDestinationService
{
    ...
    public async Task<List<DestinationV2Dto>> GetAllDestinationsV2Async()
    {
        var destinations = await _repository.GetAllAsync();
        // Returning a hardcoded or random average price as requested
        return destinations.Select(d => new DestinationV2Dto(d.Id, d.Name, 150.0 + new Random().NextDouble() * 500)).ToList();
    }
